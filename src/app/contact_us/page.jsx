...
export default function Page() {
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center">
                    ...
                    <div className={`${montserratFont.className} relative`}>
                        ...
                        >
                            ...
                            <div className="col-span-2 mt-5">
                                ...
                                <div>
                                    <div className="flex justify-between cursor-pointer rounded-[8px] border border-input bg-background px-4 py-4 text-foreground placeholder-muted-foreground focus:z-10 focus:border-primary focus:outline-none sm:text-sm" 
            ...
            <div className={`${montserratFont.className} mt-24 text-2xl sm:text-3xl md:text-4xl text-center`}>
