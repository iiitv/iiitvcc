...
export default function Confirm() {
  ...
  useEffect(() => {
    const timer = setTimeout(
      () => {
        setError(
          "The email confirmation link has expired. Please sign up again to receive a new confirmation email.",
        );
      },
      1000 * 60 * 60,
    );
        ...
        <div className="mx-auto max-w-md text-center">
          ...
          <div className="mx-auto max-w-md text-center">
            <p className="mt-4 text-muted-foreground">
              ...
              <span className="font-medium">{user_email}</span>. Click the link
