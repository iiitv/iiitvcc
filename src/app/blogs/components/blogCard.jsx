...
export default function BlogCard(props) {
  ...
  return (
    <div className="group bg-secondary rounded-2xl shadow-md hover:shadow-2xl hover:shadow-primary/10 transition-all duration-300 border border-border hover:border-primary/50 flex flex-col h-full">
      {/* Blog Poster */}
      <Link
        href={`/blog/${blog.id}`}
