    ...
    if (!data || error || !data[0].admin) {
        return (
            <div className='min-h-[80vh] w-full flex flex-col items-center px-2 sm:px-4 md:px-8'>
                ...
                <p className='text-lg sm:text-xl text-red-500 text-center'>You do not have permission to access this page.</p>
            </div>
        )
    }
    return (
            ...
            <div className='w-full flex flex-col items-center justify-center gap-20 mt-6 sm:mt-10'>
                ...
                <div className='w-full md:w-[70%] h-fit px-2 sm:px-4'>
                    <div className='flex flex-row items-end gap-3'>
                        ...
                        <p className='text-lg text-red-500'>(no cloud storage so write full blog content here at a time without reloading the page)</p>
                    </div>
                    <AddBlog />
                </div>
            </div>
