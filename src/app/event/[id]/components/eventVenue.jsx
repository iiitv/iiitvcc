...
export default function EventRequirements(props) {
	return (
		<>
			<div style={{width:"100%", height:"100%"}} className=" rounded-lg border shadow-sm bg-secondary border-none p-6 gap-6">
				<p className="event-venue-title"><OfflineIcon/>Venue</p>
                <div style={{width:"100%", height:"100%"}} ><iframe className="rounded-lg" width="100%" height="300" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Indian%20Institute%20of%20Information%20Technology%20Vadodara+(IIIT%20Vadodara)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe></div>
			</div>
		</>
	);
}
