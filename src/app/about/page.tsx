            ...
            <div className="grid gap-14 lg:grid-flow-col lg:auto-cols-max items-center">
              ...
              <div className="space-y-6 max-w-3xl text-center md:text-start">
                <div className="flex gap-7 items-center justify-center md:justify-start">
                  <h2 className="text-5xl font-bold sm:text-4xl md:text-7xl ">
                    Our
                  </h2>
                  <h2 className="text-5xl font-bold sm:text-4xl md:text-7xl ">
                    Mission
        ...
        <section className="py-20">
          <div className="container px-4 md:px-6 w-full">
            <div className="grid gap-10 lg:grid-cols-2 items-center w-full">
              <div className="space-y-6">
                <h2 className="text-primary text-4xl font-extrabold tracking-tight sm:text-8xl">
                  Meet Our Team
                </h2>
              ...
              <div className="group my-4 max-w-2xl w-full mx-auto shadow-2xl shadow-black/90 rounded-xl">
                <Link
                  href="/members"
                  className="border-2 border-transparent hover:border-white  w-full relative flex flex-col items-center justify-center container rounded-xl shadow-lg overflow-hidden cursor-pointer opacity-85 hover:opacity-100 transition-all duration-300 ease-in-out group-hover:scale-105"
                >
                  <Image
                    src={"/codingTeam.png"}
