...
import { Users, Target, Heart, Zap, Award, Globe, MoveRight, TargetIcon } from "lucide-react"
                ...
                <div className="container px-4 md:px-6">
                    <div className="grid gap-10 lg:grid-flow-col lg:auto-cols-max items-center">
                        <div className="flex items-center justify-center">
                            <Target className="h-64 w-64 text-[#db93c3] rounded-full p-4" />
                        </div>
                ...
                <div className="container px-4 md:px-6">
                    <div className="grid gap-10 lg:grid-flow-col lg:auto-cols-max items-center">
                        ...
                        <div className="flex items-center justify-center order-1 lg:order-2">
                            <Globe className="h-64 w-64 text-[#db93c3] rounded-full p-4" />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container px-4 md:px-6">
                    ...
                    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                        {values.map((value, index) => (
                            <Card key={index} className="hover:shadow-2xl shadow-black/50 hover:shadow-black text-center p-6 hover:scale-105 transition-all duration-200 shadow-lg">
