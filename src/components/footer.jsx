...
function Footer() {
  ...
  return (
    <footer className="bg-background border-t border-foreground/10 w-full flex justify-center">
      {/* Main Content */}
      <div className="w-[90%] sm:w-[85%] px-6 py-16">
        {/* Brand Section */}
        <div className="lg:col-span-1">
          <div className="flex items-center gap-8 mb-16">
            <Image
              ...
              className="w-20 h-20"
            />
            <h3 className="text-5xl text-balance sm:text-6xl font-bold tracking-tight">
              Coding Club IIITV
            </h3>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12 justify-items-start">
          {/* Quick Links */}
          <div>
            ...
            {/* Social Links */}
            <div className="hidden sm:block flex-row items-center gap-4 mt-4">
          ...
          <div className="hidden sm:block">
            ...
            <ul className="space-y-3">
              <li>
                ...
                <Link
                  href="mailto:codingclub@iiitvadodara.ac.in"
        ...
        {/* Social Links */}
        <div className="sm:hidden flex-row items-center gap-4 mb-8">
          <p className="text-base font-semibold text-foreground mb-4">
            Follow Us
          </p>
          <div className="flex gap-4">
